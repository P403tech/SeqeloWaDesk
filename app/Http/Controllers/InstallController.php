...
class InstallController extends Controller
{
    ...
    private function stepWriteEnv(array $db, array $app, array $node = []): void
    {
        ...
        $updates = [
            ...
            // Set at finalize; keep the key present so later updates never
            // treat a missing flag as "not installed".
            'APP_INSTALLED'      => 'false',
        ];
    ...
    private function stepFinalize(Request $request, array $admin, array $app): void
    {
        ...
        \App\Support\InstallState::markInstalled($payload);
        \App\Support\EnvWriter::set('APP_INSTALLED', 'true');
